...
echo -e "Downloading Gecko & Mono . . ."
mkdir -p ~/wine/share/wine/{gecko,mono}
curl -sL -o ~/wine/share/wine/gecko/wine-gecko-${GECKO_VER}-x86.msi \
    "https://dl.winehq.org/wine/wine-gecko/${GECKO_VER}/wine-gecko-${GECKO_VER}-x86.msi"
curl -sL -o ~/wine/share/wine/gecko/wine-gecko-${GECKO_VER}-x86_64.msi \
...
if [ "$TARGETPLATFORM" == "linux/amd64" ]; then
    ...
    # - these packages are needed for running wine-i386 on a 64-bit via multiarch
    dpkg --add-architecture i386 && apt-get update # enable multi-arch
    apt-get install -y libasound2-plugins:i386 libasound2:i386 libc6:i386 libcapi20-3:i386 libcups2:i386 libdbus-1-3:i386 libfontconfig1:i386 libfreetype6:i386 libglib2.0-0:i386 libglu1-mesa:i386 libgnutls30:i386 libgphoto2-6:i386 libgphoto2-port12:i386 libgsm1:i386 libgssapi-krb5-2:i386 libgstreamer-plugins-base1.0-0:i386 libgstreamer1.0-0:i386 libjpeg62-turbo:i386 libkrb5-3:i386 libncurses6:i386 libodbc1:i386 libosmesa6:i386 libpcap0.8:i386 libpng16-16:i386 libpulse0:i386 libsane1:i386 libsdl2-2.0-0:i386 libtiff6:i386 libudev1:i386 libunwind8:i386 libusb-1.0-0:i386 libv4l-0:i386 libx11-6:i386 libxcomposite1:i386 libxcursor1:i386 libxext6:i386 libxfixes3:i386 libxi6:i386 libxinerama1:i386 libxrandr2:i386 libxrender1:i386 libxslt1.1:i386 libxxf86vm1:i386 ocl-icd-libopencl1:i386 # to run wine-i386 on amd64
